...
const WRBC_FILES = "https://www.woodriverbc.org/s";

export const bibleStudies = [
  {
    book: "Psalms",
    lessons: [
      { title: "Psalm 33", url: `${WRBC_FILES}/Psalm-33.docx` },
      { title: "Psalm 78:1-8", url: `${WRBC_FILES}/Psalm78_1-8.docx` },
      { title: "Psalm 45", url: `${WRBC_FILES}/Psalm-45.docx` },
      { title: "Psalm 42", url: `${WRBC_FILES}/Psalm-42.docx` },
      { title: "Psalm 37", url: `${WRBC_FILES}/Psalm-37.docx` },
      { title: "Psalm 32", url: `${WRBC_FILES}/Psalm-32.docx` },
      { title: "Psalm 27", url: `${WRBC_FILES}/Psalm-27.docx` },
    ],
  },
  {
    book: "1 Corinthians",
    lessons: [
      { title: "1 Corinthians 1:1-8", url: `${WRBC_FILES}/1-Cor-1_1-8.docx` },
      { title: "1 Corinthians 1:9-16", url: `${WRBC_FILES}/1-Cor-1_9-16.docx` },
      { title: "1 Corinthians 1:17-25", url: `${WRBC_FILES}/1-Cor-1_17-25.docx` },
      { title: "1 Corinthians 1:26-32", url: `${WRBC_FILES}/1-Cor-1_26-32.docx` },
      { title: "1 Corinthians 2:1-6", url: `${WRBC_FILES}/1-Cor-2_1-6.docx` },
      { title: "1 Corinthians 2:7-16", url: `${WRBC_FILES}/1-Cor-2_7-16.docx` },
      { title: "1 Corinthians 3:1-11", url: `${WRBC_FILES}/1-Cor-3_1-11.docx` },
      { title: "1 Corinthians 3:12-26", url: `${WRBC_FILES}/1-Cor-3_12-26.docx` },
      { title: "1 Corinthians 4:1-5", url: `${WRBC_FILES}/1-Cor-4_1-5.docx` },
      { title: "1 Corinthians 4:6-13", url: `${WRBC_FILES}/1-Cor-4_6-13.docx` },
      { title: "1 Corinthians 4:14-21", url: `${WRBC_FILES}/1-Cor-4_14-21.docx` },
      { title: "1 Corinthians 5", url: `${WRBC_FILES}/1-Cor-5_1-13.docx` },
      { title: "1 Corinthians 6", url: `${WRBC_FILES}/1-Cor-6.docx` },
      { title: "1 Corinthians 7:1-7", url: `${WRBC_FILES}/1-Cor-7_1-7.docx` },
      { title: "1 Corinthians 7:8-16", url: `${WRBC_FILES}/1-Cor-7_8-16.docx` },
      { title: "1 Corinthians 7:18-24", url: `${WRBC_FILES}/1-Cor-7_18-24.docx` },
      { title: "1 Corinthians 7:25-40", url: `${WRBC_FILES}/1-Cor-7_25-40.docx` },
      { title: "1 Corinthians 8:1-13", url: `${WRBC_FILES}/1-Cor-8_1-13.docx` },
    ],
  },
  {
    book: "Galatians",
    lessons: [
      { title: "Galatians 5:1-12", url: `${WRBC_FILES}/Galatians-5_1-12.docx` },
      { title: "Galatians 4:17-31", url: `${WRBC_FILES}/Galatians-4_17-31.docx` },
      { title: "Galatians 4:8-16", url: `${WRBC_FILES}/Galatians-4_8-16.docx` },
      { title: "Galatians 4:1-7", url: `${WRBC_FILES}/Galatians-4_1-7.docx` },
      { title: "Galatians 3:19-29", url: `${WRBC_FILES}/Galatians-3_19-29.docx` },
      { title: "Galatians 3:10-19", url: `${WRBC_FILES}/Galatians-3_10-19.docx` },
    ],
  },
  {
    book: "I John",
    lessons: [
      { title: "Knowing God — I John 2:13", url: `${WRBC_FILES}/Knowing-God.pdf` },
      { title: "The True Light Now Shineth — I John 2:8", url: `${WRBC_FILES}/The-True-Light-Now-Shineth.pdf` },
      { title: "We Know Him — I John 2:3", url: `${WRBC_FILES}/We-Know-Him.pdf` },
      { title: "We Have An Advocate — I John 2:1-2", url: `${WRBC_FILES}/We-Have-An-Advocate.pdf` },
      { title: "God Is Light — I John 1:5-7", url: `${WRBC_FILES}/God-Is-Light.pdf` },
      { title: "The Word of Life — I John 1:1-4", url: `${WRBC_FILES}/The-Word-of-Life.pdf` },
    ],
  },
  {
    book: "Habakkuk",
    lessons: [
      { title: "A Man With A Burden — Habakkuk 1:1", url: `${WRBC_FILES}/A-Man-With-A-Burden-qol1.pdf` },
      { title: "The Question All People Ask — Habakkuk 1:3", url: `${WRBC_FILES}/The-Question-All-People-Ask-And-No-One-Can-Answer.pdf` },
      { title: "Remember God Is At Work — Habakkuk 1:5", url: `${WRBC_FILES}/Remember-God-Is-At-Work-yu6f.pdf` },
      { title: "The God I Know — Habakkuk 1:12", url: `${WRBC_FILES}/The-God-I-Know-ghd0.pdf` },
      { title: "Living By Faith — Habakkuk 2:4", url: `${WRBC_FILES}/Living-By-Faith.pdf` },
      { title: "All We Want Is More — Habakkuk 2:9", url: `${WRBC_FILES}/All-We-Want-Is-More.pdf` },
      { title: "When Stones Speak And Timbers Answer — Habakkuk 2:11", url: `${WRBC_FILES}/When-Stones-Speak-And-Timbers-Answer.pdf` },
      { title: "Calling On Gods That Cannot Answer — Habakkuk 2:19", url: `${WRBC_FILES}/Calling-On-Gods-that-cannot-answer.pdf` },
      { title: "The Heart Cry for Revival — Habakkuk 3:1-2", url: `${WRBC_FILES}/The-Heart-Cry-for-Revival-f7lx.pdf` },
      { title: "The Fear of the Lord — Habakkuk 3:16", url: `${WRBC_FILES}/The-Fear-of-the-Lord.pdf` },
      { title: "Rejoicing in the Lord — Habakkuk 3:19", url: `${WRBC_FILES}/Rejoicing-in-the-Lord.pdf` },
    ],
  },
] as const;
