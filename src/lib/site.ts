...
export const textPages: Record<string, TextPage> = {
  ...
  "pastor": {
    ...
    paragraphs: [
      "He grew up with parents who loved him and taught him right from wrong, but he came to see his own need of salvation during his college years in North Carolina.",
      "Through faithful Christian friends, church invitations, Bible studies, and the preaching of Christ, he trusted Jesus Christ as Saviour in October of his sophomore year.",
      "In April of 2003 he came back to Rhode Island to serve under Pastor Chris Baker at Knotty Oak Baptist Church. He later married Heather, and they have five children: Riley, Lilyana, Chloe, Avery, and Bailey.",
      "In October of 2011 he was asked to pastor Wood River Baptist Church. His desire is to honour the Lord day by day in the church, the community, and his home.",
    ],
  },
  "covenant": {
